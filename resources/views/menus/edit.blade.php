...
<div class="max-w-2xl card">
    <div class="card-header">
        <h2 class="text-display-sm text-ink">Edit Menu</h2>
    </div>

    <form action="{{ route('menus.update', $menu) }}" method="POST" class="card-body">
        @csrf
        @method('PUT')
        ...
        <div class="space-y-6">
            <div>
                ...
                <input type="text" name="name" id="name" value="{{ old('name', $menu->name) }}" class="input-airbnb" required>
                @error('name')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="price" id="price" value="{{ old('price', round($menu->price)) }}" min="0" step="100" class="input-airbnb pl-10">
                    </div>
                </div>
            </div>
            ...
            <div class="pt-2">
                <div class="flex items-center">
                    <input id="is_active" name="is_active" type="checkbox" value="1" {{ old('is_active', $menu->is_active) ? 'checked' : '' }} class="h-4 w-4 rounded border-hairline text-rausch focus:ring-rausch">
